...
class ControllerModuleTGKSProMegamenu extends Controller {
	...
	public function index() {  
		...
		if(isset($_GET['delete'])) {
			...
			$this->response->redirect($this->url->link('module/tg_kspro_megamenu', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['action'] = $this->url->link('module/tg_kspro_megamenu', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/tg_kspro_megamenu', 'token=' . $this->session->data['token'], 'SSL')
		);
		...
		$this->response->setOutput($this->load->view('module/tg_kspro_megamenu.tpl', $data));
