...
class ControllerModuleTGKSproFilterProduct extends Controller {
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('module/tg_kspro_filter_product', 'token=' . $this->session->data['token'], 'SSL'));			
		}
		...
		$data['action'] = $this->url->link('module/tg_kspro_filter_product', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('module/tg_kspro_filter_product.tpl', $data));
	}
