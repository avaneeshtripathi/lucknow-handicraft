...
class ControllerModuleTGKSProRevolutionSlider extends Controller {
	...
	public function slider() {
		...
		if(isset($_GET['slider_id'])) {
			...
			if($data == false) { 
				$this->response->redirect($this->url->link('module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], 'SSL'));
			}
		...
		$data['action'] = $this->url->link('module/tg_kspro_revolution_slider/slider', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], 'SSL')
		);
		...
		$this->response->setOutput($this->load->view('module/tg_kspro_revolution_slider/slider.tpl', $data));
	}
	...
	public function sliders() {
		...
		$data['action'] = $this->url->link('module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], 'SSL');
		$data['placement'] = $this->url->link('module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], 'SSL');		
		$data['existing'] = $this->url->link('module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], 'SSL');	
		$data['link_slider'] = $this->url->link('module/tg_kspro_revolution_slider/slider', 'token=' . $this->session->data['token'], 'SSL');	
		$data['token'] = $this->session->data['token'];
		...
		$this->response->setOutput($this->load->view('module/tg_kspro_revolution_slider/sliders.tpl', $data));
	}
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		$data['action'] = $this->url->link('module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], 'SSL');
		$data['placement'] = $this->url->link('module/tg_kspro_revolution_slider', 'token=' . $this->session->data['token'], 'SSL');		
		$data['existing'] = $this->url->link('module/tg_kspro_revolution_slider/sliders', 'token=' . $this->session->data['token'], 'SSL');		
		$data['token'] = $this->session->data['token'];
		...
		$this->response->setOutput($this->load->view('module/tg_kspro_revolution_slider/placement.tpl', $data));
	}
